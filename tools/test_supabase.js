...
var supabaseKey = process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY || process.env.SUPABASE_ANON_KEY;
// Auto-correção: O usuário colou apenas o ID do projeto em vez da URL completa
if (supabaseUrl && !supabaseUrl.startsWith('http')) {
    supabaseUrl = "https://".concat(supabaseUrl, ".supabase.co");
}
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    console.log("\u2705 Dados Retornados (Ping Count): ".concat(data === null || data === void 0 ? void 0 : data.length));
                    console.log("-----------------------------------------------------");
